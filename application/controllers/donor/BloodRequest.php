...
class BloodRequest extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('donor/bloodrequest/index',$data);
	...
	public function stockDisplay(){
		...
		$data['stock']=$this->BloodRequest_model->getStock();  
         //return the data in view   
		$this->load->view('donor/header');
		$this->load->view('donor/index',$data);
		 $this->load->view('donor/footer');
	}
	public function create(){
		...
		$data['hospital']=$this->BloodRequest_model->display();  
         //return the data in view  
		$this->load->view('donor/header');
		$this->load->view('donor/bloodrequest/create',$data);
		 $this->load->view('donor/footer');
	}
		   ...
		   $num=$row->unit;
			...
			$sid=1;
			 if($s=='pending'){
                ...
                redirect(base_url('donor/bloodrequest'));
					 }
					 else{
