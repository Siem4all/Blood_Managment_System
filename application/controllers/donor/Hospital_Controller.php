...
class Hospital_Controller extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('donor/hospital/index',$data);
	...
	public function create(){
		...
		$data['user']=$this->Hospital_model->display();  
         //return the data in view  
		$this->load->view('donor/header');
		$this->load->view('donor/hospital/create',$data);
		 $this->load->view('donor/footer');
	}
	...
	public function donation(){
		...
		$data['donors']=$this->Donor_model->donation();  
         //return the data in view   
		$this->load->view('donor/header');
		$this->load->view('donor/donation/index',$data);
		 $this->load->view('donor/footer');
	}
	...
	public function edit($id){
		//load session library
         ...
         //return the data in view  
		$this->load->view('donor/header');
		$this->load->view('donor/hospital/edit',$data);
		 $this->load->view('donor/footer');
	}
	public function emailEdit($id){
		...
		$data['user']=$this->Donor_model->display();  
         //return the data in view  
		$this->load->view('donor/header');
		$this->load->view('donor/donor/edit',$data);
		 $this->load->view('donor/footer');
	}
            ...
            if(empty($email)){
             ...
             $update = $this->Hospital_model->hospitalUpdate($data,$id);
			  if($update==true){
                ...
                redirect(base_url('donor/hospital'));
