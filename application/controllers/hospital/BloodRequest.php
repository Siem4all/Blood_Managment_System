...
class BloodRequest extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('hospital/bloodrequest/index',$data);
	...
	public function create(){
		...
		$data['hospital']=$this->BloodRequest_model->display();  
         //return the data in view  
		$this->load->view('hospital/header');
		$this->load->view('hospital/bloodrequest/create',$data);
		 $this->load->view('hospital/footer');
	}
        ...
        {   $name=$this->input->post('hospital');
		  ...
		  $hospital = $this->BloodRequest_model->getId($name);
			...
			$this->BloodRequest_model->addRequest($data);
                ...
                redirect(base_url('hospital/bloodrequest'));    
            ...
            if(empty($email)){
             ...
             $update = $this->Hospital_model->hospitalUpdate($data,$id);
			  if($update==true){
                ...
                redirect(base_url('hospital/hospital'));
