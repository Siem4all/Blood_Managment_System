...
class Event extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('hospital/events/index',$data);
	...
	public function create(){
		//load session library
         //return the data in view  
		$this->load->view('hospital/header');
		$this->load->view('hospital/events/create');
		 $this->load->view('hospital/footer');
	}
public function store(){
	...
	public function edit($id){
		//load session library
         ...
         //return the data in view  
		$this->load->view('hospital/header');
		$this->load->view('hospital/events/edit',$data);
		 $this->load->view('hospital/footer');
	}
	...
	public function update($id){
       ...
       if($update==true){
                ...
                redirect(base_url('hospital/event'));
            }
            else
            {
                $this->session->set_flashdata('error','Something Went Wrong.!');
