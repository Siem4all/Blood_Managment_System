...
class Blood_Controller extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('nurse/blood/index',$data);
	...
	public function create($id){
		...
		$data['id']=$id;  
		$this->load->view('nurse/header');
		$this->load->view('nurse/blood/create',$data);
		 $this->load->view('nurse/footer');
	}
	public function show(){
		...
		$data['donors']=$this->Blood_model->getAll();  
         //return the data in view   
		$this->load->view('nurse/header');
		$this->load->view('nurse/donor/index',$data);
		 $this->load->view('nurse/footer');
	}
	...
	public function donation(){
		...
		$data['donors']=$this->Donor_model->donation();  
         //return the data in view   
		$this->load->view('nurse/header');
		$this->load->view('nurse/donation/index',$data);
		 $this->load->view('nurse/footer');
	}
	...
	public function edit($id){
		//load session library
         ...
         //return the data in view  
		$this->load->view('nurse/header');
		$this->load->view('nurse/blood/edit',$data);
		 $this->load->view('nurse/footer');
	}
