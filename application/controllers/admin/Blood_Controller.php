...
class Blood_Controller extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('admin/blood/index',$data);
	...
	public function create($id){
		...
		$data['events']=$this->User_model->notification(); 
			$data['contacts']=$this->User_model->comments();
		$this->load->view('admin/header',$data);
		$this->load->view('admin/blood/create',$data);
		 $this->load->view('admin/footer');
	}
	public function show(){
		...
		$data['events']=$this->User_model->notification(); 
         ...
         //return the data in view   
		$this->load->view('admin/header',$data);
		$this->load->view('admin/donor/index',$data);
		 $this->load->view('admin/footer');
	}
        ...
        else
        {
           ...
           if($existed==false){
            ...
            if($insert){
                ...
                redirect(base_url('admin/blood'));    
            }
            else
            {
                $this->session->set_flashdata('error','Something Went Wrong.!');
                redirect(base_url('blood/create/'.$id));
            }
		   }
			else
			{
			...
			foreach ($blood as $row)
			 ...
			 $add = $this->Blood_model->updateBlood($data,$id);
			  if($add==true){
                ...
                redirect(base_url('admin/donor/get_all'));
            }
            else
            {
                $this->session->set_flashdata('error','Something Went Wrong.!');
	...
	public function edit($id){
		...
		$data['events']=$this->User_model->notification(); 
         ...
         //return the data in view  
		$this->load->view('admin/header',$data);
		$this->load->view('admin/blood/edit',$data);
		 $this->load->view('admin/footer');
	}
