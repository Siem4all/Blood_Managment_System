...
class BloodRequest extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('admin/bloodrequest/index',$data);
	...
	public function create(){
		...
		$data['events']=$this->User_model->notification(); 
         ...
         //return the data in view  
		$this->load->view('admin/header',$data);
		$this->load->view('admin/bloodrequest/create',$data);
		 $this->load->view('admin/footer');
	}
        ...
        {   $name=$this->input->post('hospital');
		  ...
		  $hospital = $this->BloodRequest_model->getId($name);
			...
			$this->BloodRequest_model->addRequest($data);
                ...
                redirect(base_url('admin/bloodrequest'));    
            ...
            if(empty($email)){
             ...
             $update = $this->Hospital_model->hospitalUpdate($data,$id);
			  if($update==true){
                ...
                redirect(base_url('admin/hospital'));
