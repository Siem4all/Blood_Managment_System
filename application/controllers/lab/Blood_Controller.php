...
class Blood_Controller extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('lab/blood/index',$data);
	...
	public function create($id){
		...
		$data['id']=$id;  
		$this->load->view('lab/header');
		$this->load->view('lab/blood/create',$data);
		 $this->load->view('lab/footer');
	}
	public function show(){
		...
		$data['donors']=$this->Blood_model->getAll();  
         //return the data in view   
		$this->load->view('lab/header');
		$this->load->view('lab/donor/index',$data);
		 $this->load->view('lab/footer');
	}
	...
	public function edit($id){
		//load session library
         ...
         //return the data in view  
		$this->load->view('lab/header');
		$this->load->view('lab/blood/edit',$data);
		 $this->load->view('lab/footer');
	}
